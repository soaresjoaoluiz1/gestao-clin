    ...
    <div>
      ...
      <section className="dash-section">
        <div className="metrics-grid">
          <div className="metric-card"><div className="metric-header"><span className="metric-label">Contas Ativas</span><div className="metric-icon" style={{ background: '#5CB8B220', color: '#5CB8B2' }}><Building2 size={16} /></div></div><div className="metric-value">{data.accounts.length}</div></div>
